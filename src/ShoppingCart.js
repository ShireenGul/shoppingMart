...
let names = ['Shampoo', 'facewash', 'Brush', 'Pin', 'Comb', 'Perfume', 'glasses', 'Soap'];
let Prices = ['200', '100', '50', '350', '300', '250', '100', '250'];
let urls = ['https://source.unsplash.com/400x300/?Shampoo',
    'https://source.unsplash.com/400x300/?facewash',
    'https://source.unsplash.com/400x300/?Brush',
    'https://source.unsplash.com/400x300/?pin',
    'https://source.unsplash.com/400x300/?comb',
    'https://source.unsplash.com/400x300/?perfume',
    'https://source.unsplash.com/400x300/?glasses',
    'https://source.unsplash.com/400x300/?soap'];
function addRows() {
    let i = 0;
...
function addquntities(iD) {
    ...
    quantity.innerHTML = num + 1;
    let price = el.querySelector('.price');
    let total = el.querySelector('.total')
    total.innerHTML = parseInt(price.innerHTML) * parseInt(quantity.innerHTML);
